            ...
            <div className='row footer'>
                ...
                <ul className="col col-3">
                    <p>Đặc Sản Nổi Bật
                        <br />
                        <li>
                            <Link className='footer-link' to='/menu'>Phở Hà Nội</Link>
                        </li>
                        <li>
                            <Link className='footer-link' to='/menu'>Bún bò Huế</Link>
                        </li>
                        <li>
                            <Link className='footer-link' to='/menu'>Mỳ quảng</Link>
                        </li>
                    </p>
                </ul>
                ...
                <ul className="col col-3">
                    <p>Liên Kết Nhanh
                        <br />
                        <li>
                            <Link className='footer-link' to='/menu'>Danh sách món ăn</Link>
                        </li>
                        <li>
                ...
                {/* Bản quyền */}
                <ul>
                    <li>2025 AmThucVN. All rights reserved</li>
                </ul>
            </div>
        </footer>
    );
